        ...
        <div class="main">
            <div class="addItem">
                ...
                <form action="{{ route('events.store') }}" method="post" class="addItemForm">
                    ...
                    <div class="addItemForm__group">
                        <select class="addItemForm__select" name="id_event_type" id="" required>
                    ...
                    <div class="addItemForm__group">
                        <select class="addItemForm__select" name="id_event_level" id="" required>
                    ...
                    <div class="addItemForm__group">
                        <select class="addItemForm__select" name="id_event_status" id="" required>
                    ...
                    <div class="addItemForm__group">
                        <select class="addItemForm__select" name="id_user" id="" required>
