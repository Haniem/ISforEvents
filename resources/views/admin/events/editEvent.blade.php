        ...
        <div class="main">
            ...
            <form class="editItemForm" action="{{ route('events.update', $event->id) }}" method="POST">
                ...
                <div class="editItemForm__item">
                    ...
                    <input name="event_name" type="text" class="editItemForm__input" value="{{ $event -> event_name }}">
                </div>

                <div class="editItemForm__item">
                    <label for="" class="editItemForm__label"></label>
                    <input name="event_discrtiption" type="text" class="editItemForm__input" value="{{ $event -> event_discrtiption }}">
                </div>

                <div class="editItemForm__item">
                    <label for="" class="editItemForm__label"></label>
                    <input name="event_format" type="text" class="editItemForm__input" value="{{ $event ->  event_format}}">
                </div>

                <div class="editItemForm__item">
                    <label for="" class="editItemForm__label"></label>
                    <input name="begin_date" type="date" class="editItemForm__input" value="{{ $event ->  begin_date}}">
                </div>
